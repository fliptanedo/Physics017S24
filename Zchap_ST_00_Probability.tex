...
\chapter{A probability refresher}

\section{Discrete probability}

Let $A$ and $B$ be events with probability $P(A)$ and $P(A)$ respectively. The probabilities are numbers $0\leq P(X) \leq 1$. We may also define the \textbf{conditional probability}, $P(A|B)$, which is the probability of $A$ given that $B$ is true. 
